...
After saving, the visualisation will be uploaded to your profile, which will automatically open in a new browser window. Adjust the settings of your new visualisation by clicking the gear on the toolbar and toggling where to show the visualisation and to allow access.
